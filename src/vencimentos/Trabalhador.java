...
public abstract class Trabalhador implements Comparable {
    ...
    public int compareTo(Object outro){
        float outroVencimento = ((Trabalhador) outro).vencimento();
        float esteVencimento = this.vencimento();
        if (esteVencimento < outroVencimento) return -1;
        else if(esteVencimento > outroVencimento) return 1;
        else return 0;
    }
}
